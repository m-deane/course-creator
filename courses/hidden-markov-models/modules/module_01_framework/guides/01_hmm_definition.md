...
> **Reading time:** ~5 min | **Module:** Module 1: Framework | **Prerequisites:** Module 0 Foundations

<div class="callout-key">

**Key Concept Summary:** In a standard Markov chain, we observe the states directly. In an HMM, states are **hidden** and we only observe **emissions** generated by those states.
...
1. Explain the core idea of hmm framework and definition in your own words to a colleague who has not studied it.

2. What is the most common mistake practitioners make when applying hmm framework and definition, and how would you avoid it?
...
<a class="link-card" href="./01_hmm_definition_slides.md">
...
<a class="link-card" href="./02_hmm_parameters.md">
  <div class="link-card-title">02 Hmm Parameters</div>
