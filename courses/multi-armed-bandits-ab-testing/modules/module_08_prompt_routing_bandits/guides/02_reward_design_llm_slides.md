...
flowchart TD
    ...
    style PM fill:#6f6,color:#000
    style GR fill:#f66,color:#fff
    style Final fill:#36f,color:#fff
```
...
flowchart LR
    ...
    style Inv fill:#6f6,color:#000
    style Sig fill:#36f,color:#fff
    style Hal fill:#f66,color:#fff
```
...
flowchart TD
    ...
    style Composite fill:#6f6,color:#000
```
