...
<!-- Speaker notes: Cover the key points on this slide about Your First Cloud Flow. Pause for questions if the audience seems uncertain. -->
...
<!-- Speaker notes: Cover the key points on this slide about What Is a Cloud Flow?. Pause for questions if the audience seems uncertain. -->
...
<!-- Speaker notes: Cover the key points on this slide about Anatomy of a Flow. Pause for questions if the audience seems uncertain. -->
...
<!-- Speaker notes: Cover the key points on this slide about The Flow Designer Canvas. Pause for questions if the audience seems uncertain. -->
...
<!-- Speaker notes: Cover the key points on this slide about Canvas Layout Overview. Pause for questions if the audience seems uncertain. -->
...
<!-- Speaker notes: Cover the key points on this slide about Toolbar Deep Dive. Pause for questions if the audience seems uncertain. -->
...
<!-- Speaker notes: Cover the key points on this slide about Dynamic Content Panel. Pause for questions if the audience seems uncertain. -->
...
<!-- Speaker notes: Cover the key points on this slide about Building: Daily Weather Email. Pause for questions if the audience seems uncertain. -->
...
<!-- Speaker notes: Cover the key points on this slide about Step 1 & 2 — Create the Flow. Pause for questions if the audience seems uncertain. -->
...
<!-- Speaker notes: Cover the key points on this slide about Step 3 — Configure the Recurrence Trigger. Pause for questions if the audience seems uncertain. -->
...
<!-- Speaker notes: Cover the key points on this slide about Step 4 — Add MSN Weather Action. Pause for questions if the audience seems uncertain. -->
...
<!-- Speaker notes: Cover the key points on this slide about Step 5 — Add Outlook Send Email Action. Pause for questions if the audience seems uncertain. -->
...
<!-- Speaker notes: Cover the key points on this slide about Step 6 & 7 — Save and Test. Pause for questions if the audience seems uncertain. -->
...
<!-- Speaker notes: Cover the key points on this slide about Common First-Flow Mistakes. Pause for questions if the audience seems uncertain. -->
...
<!-- Speaker notes: Cover the key points on this slide about Top 5 Mistakes and Fixes. Pause for questions if the audience seems uncertain. -->
