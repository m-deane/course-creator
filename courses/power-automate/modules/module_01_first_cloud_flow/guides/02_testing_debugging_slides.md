...
graph LR
    ...
    style X fill:#A4262C,color:#fff
    style FX fill:#6264A7,color:#fff
```
...
graph LR
    ...
    style FC fill:#6264A7,color:#fff
    style T fill:#0078D4,color:#fff
    style RH fill:#217346,color:#fff
```
...
graph TD
    ...
    style OUT fill:#217346,color:#fff
```
...
graph TD
    ...
    style START fill:#A4262C,color:#fff
    style E1 fill:#217346,color:#fff
    style E2 fill:#217346,color:#fff
    style E3 fill:#217346,color:#fff
    style E4 fill:#217346,color:#fff
    style E5 fill:#217346,color:#fff
```
