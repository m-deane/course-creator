...
graph TD
    ...
    TB --> DR["Delete a row\n→ remove by row ID"]
    style WB fill:#217346,color:#fff
    style TB fill:#217346,color:#fff
    style LR fill:#0078D4,color:#fff
    style AR fill:#0078D4,color:#fff
    style GR fill:#0078D4,color:#fff
    style UR fill:#6264A7,color:#fff
    style DR fill:#A4262C,color:#fff
```
...
graph TD
    ...
    VA --> AE["Apply to each\n(iterate row by row)"]
    style LR fill:#0078D4,color:#fff
    style VA fill:#217346,color:#fff
    style AE fill:#6264A7,color:#fff
```
...
graph TD
    ...
    style GA fill:#0078D4,color:#fff
    style LR fill:#0078D4,color:#fff
    style LF fill:#6264A7,color:#fff
```
...
graph TD
    ...
    style LR fill:#0078D4,color:#fff
    style AE fill:#0078D4,color:#fff
    style AR fill:#217346,color:#fff
    style SE fill:#217346,color:#fff
```
...
graph TD
    ...
    F4 -->|Yes| SP
    F1 -->|No| Q
    style EX fill:#217346,color:#fff
